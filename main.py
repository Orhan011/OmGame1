...
def leaderboard():
    ...
    three_d_rotation_scores = Score.query.filter_by(game_type='3dRotation').order_by(Score.score.desc()).limit(10).all()
    ...
    return render_template('leaderboard.html', 
                          ...
                          three_d_rotation_scores=three_d_rotation_scores)
