...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Yeniden başlat butonu (Play Again olarak değiştirildi)
  const playAgainButton = document.getElementById('play-again');
  if (playAgainButton) {
    playAgainButton.addEventListener('click', startGame); // ResetGame yerine startGame kullanıldı.
  }
});